...
export interface CrmPerson {
  id: string;
  /** SharePoint list item Id (3Edge_CRM_Persons). */
  spId?: number;
  name: string;
...
export interface CrmCompany {
  id: string;
  /** SharePoint list item Id (3Edge_CRM_Companies). */
  spId?: number;
  name: string;
  labels: string;
  address: string;
...
export interface CrmRfq extends CrmEnquiryCore {
  id: string;
  /** SharePoint list item Id (3Edge_CRM_RFQs). */
  spId?: number;
  rfqNum: string;
...
export interface CrmQuote extends CrmEnquiryCore {
  id: string;
  /** SharePoint list item Id (3Edge_CRM_Quotes). */
  spId?: number;
  quoteNum: string;
  rfqId: string;
  rfqNum: string;
...
export interface CrmProject extends CrmEnquiryCore {
  id: string;
  projNum: string;
  /** SharePoint list item Id (3Edge_CRM_WIP). */
  spId?: number;
  spProjectId?: number;
  quoteId: string;
  quoteNum: string;
